...
// BackgroundCircles
export const BackgroundCircles = ({ perallaxRef }) => {
  ...
  return (
    ...
    >
      ...
      <MouseParallax strength={0.07} parallaxContainerRef={perallaxRef}>
        ...
        <div
          className="
              absolute bottom-1/2 lef1/2
               w-0.25 h-1/2 origin-bottom rotate-[54deg]"
        >
          <div
